...
export function setLocalStorageConfig(val: Config) {
  localStorageConfig = val;
}

export function setDbConfigLoaded(val: boolean) {
  dbConfigLoaded = val;
}

export function setChangedBeforeDb(val: boolean) {
  changedBeforeDb = val;
}
...
function isConfigKeyValid(name: string) {
...
export async function saveToLocalStorage(noDbCheck = false) {
  ...
  // TODO delete Command when CommandlineLists is done
  CommandlineLists.defaultCommands.list.filter(
    (command: Command) => command.id === "exportSettingsJSON"
...
//numbers
export function setNumbers(numb: boolean, nosave?: boolean) {
...
//punctuation
export function setPunctuation(punc: boolean, nosave?: boolean) {
  if (config.mode === "quote") {
    punc = false;
  }
...
export function setMode(mode: Mode, nosave?: boolean) {
...
export function setPlaySoundOnError(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = false;
  }
...
export function setPlaySoundOnClick(val: PlaySoundOnClick, nosave?: boolean) {
  if (val === undefined) {
    val = "off";
  }
...
export function setSoundVolume(val: SoundVolume, nosave?: boolean) {
  if (val === undefined) {
    val = "1.0";
  }
...
//difficulty
export function setDifficulty(diff: Difficulty, nosave?: boolean) {
  if (
...
//set fav themes
export function setFavThemes(themes: Theme[], nosave?: boolean) {
...
export function setFunbox(funbox: Funbox, nosave?: boolean) {
...
export function setBlindMode(blind: boolean, nosave?: boolean) {
  if (blind === undefined) {
    blind = false;
  }
  config.blindMode = blind;
...
export function setChartAccuracy(chartAccuracy: boolean, nosave?: boolean) {
...
export function setChartStyle(chartStyle: ChartStyle, nosave?: boolean) {
...
export function setStopOnError(soe: StopOnError | boolean, nosave?: boolean) {
...
export function setAlwaysShowDecimalPlaces(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = false;
  }
...
export function setAlwaysShowCPM(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = false;
  }
...
export function setShowOutOfFocusWarning(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = true;
  }
...
export function setSwapEscAndTab(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = false;
  }
...
//pace caret
export function setPaceCaret(val: PaceCaret, nosave?: boolean) {
  if (val === undefined) {
    val = "off";
  }
...
export function setRepeatedPace(pace: boolean, nosave?: boolean) {
  if (pace === undefined) {
    pace = true;
  }
  config.repeatedPace = pace;
...
//min wpm
export function setMinWpm(minwpm: MinimumWordsPerMinute, nosave?: boolean) {
  if (minwpm === undefined) {
    minwpm = "off";
  }
...
export function setMinWpmCustomSpeed(val: number | string, nosave?: boolean) {
  val = parseInt(val.toString());
  if (val === undefined || Number.isNaN(val)) {
    val = 100;
  }
...
//min acc
export function setMinAcc(min: MinimumAccuracy, nosave?: boolean) {
  if (min === undefined) {
    min = "off";
  }
  config.minAcc = min;
...
export function setMinAccCustom(val: number | string, nosave?: boolean) {
  val = parseInt(val.toString());
  if (val === undefined || Number.isNaN(val)) {
    val = 90;
  }
...
//min burst
export function setMinBurst(min: MinimumBurst, nosave?: boolean) {
  if (min === undefined) {
    min = "off";
  }
  config.minBurst = min;
...
export function setMinBurstCustomSpeed(val: number | string, nosave?: boolean) {
  val = parseInt(val.toString());
  if (val === undefined || Number.isNaN(val)) {
    val = 100;
  }
...
export function setAlwaysShowWordsHistory(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = false;
  }
...
//caps lock warning
export function setCapsLockWarning(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = false;
  }
...
export function setShowAllLines(sal: boolean, nosave?: boolean) {
  if (sal === undefined) {
    sal = false;
  }
  config.showAllLines = sal;
...
export function setQuickEnd(qe: boolean, nosave?: boolean) {
  if (qe === undefined) {
    qe = false;
  }
  config.quickEnd = qe;
...
export function setEnableAds(val: EnableAds | boolean, nosave?: boolean) {
...
export function setRepeatQuotes(val: RepeatQuotes | boolean, nosave?: boolean) {
  if (val === undefined || val === true || val === false) {
    val = "off";
  }
...
//flip colors
export function setFlipTestColors(flip: boolean, nosave?: boolean) {
  if (flip === undefined) {
    flip = false;
  }
...
//extra color
export function setColorfulMode(extra: boolean, nosave?: boolean) {
  if (extra === undefined) {
    extra = false;
  }
...
//strict space
export function setStrictSpace(val: boolean, nosave?: boolean) {
  if (val === undefined) {
    val = false;
  }
...
export function setOppositeShiftMode(val: OppositeShiftMode, nosave?: boolean) {
  if (val === undefined) {
    val = "off";
  }
...
export function setPageWidth(val: PageWidth, nosave?: boolean) {
...
export function setCaretStyle(caretStyle: CaretStyle, nosave?: boolean) {
...
export function setPaceCaretStyle(caretStyle: CaretStyle, nosave?: boolean) {
  if (caretStyle === null || caretStyle === undefined) {
    caretStyle = "default";
  }
...
export function setShowTimerProgress(timer: TimerProgress, nosave?: boolean) {
...
export function setShowLiveWpm(live: boolean, nosave?: boolean) {
...
export function setShowLiveAcc(live: boolean, nosave?: boolean) {
  if (live === null || live === undefined) {
    live = false;
  }
...
export function setShowLiveBurst(live: boolean, nosave?: boolean) {
  if (live === null || live === undefined) {
    live = false;
  }
...
export function setHighlightMode(mode: HighlightMode, nosave?: boolean) {
  if (
    mode === "word" &&
...
export function setHideExtraLetters(val: boolean, nosave?: boolean) {
  if (val === null || val === undefined) {
    val = false;
  }
...
export function setTimerStyle(style: TimerStyle, nosave?: boolean) {
...
export function setTimerColor(color: TimerColor, nosave?: boolean) {
...
export function setTimerOpacity(opacity: TimerOpacity, nosave?: boolean) {
...
//key tips
export function setKeyTips(keyTips: boolean, nosave?: boolean) {
...
export function setTimeConfig(
  time: TimeModes | `${TimeModes}`,
  nosave?: boolean
) {
  if (
    time === null ||
    (time !== "custom" && isNaN(time as NoncustomTimeModes)) ||
    time < 0
  ) {
    time = 15;
  }
  time = parseInt(time.toString()) as TimeModes;
  // if (!nosave) setMode("time", nosave);
  config.time = time;
  $("#top .config .time .text-button").removeClass("active");
  if (![15, 30, 60, 120].includes(time as NoncustomTimeModes)) {
    time = "custom";
  }
...
export function setQuoteLength(
  len: QuoteLength | QuoteLengthArray,
  nosave?: boolean,
  ...
  if (Array.isArray(len)) {
    ...
    len = parseInt(len.toString()) as QuoteLength;
    if (multipleMode) {
...
export function setWordCount(
  wordCount: WordsModes | `${WordsModes}`,
  nosave?: boolean
) {
  wordCount = parseInt(wordCount.toString()) as NoncustomWordsModes;
  if (
    wordCount === null ||
    isNaN(wordCount) ||
    wordCount < 0 ||
  ...
  if (![10, 25, 50, 100, 200].includes(wordCount as NoncustomWordsModes)) {
    wordCount = "custom";
  }
...
//caret
export function setSmoothCaret(mode: boolean, nosave?: boolean) {
...
export function setStartGraphsAtZero(mode: boolean, nosave?: boolean) {
  config.startGraphsAtZero = mode;
  if (!nosave) saveToLocalStorage();
}

//linescroll
export function setSmoothLineScroll(mode: boolean, nosave?: boolean) {
...
//quick tab
export function setQuickTabMode(mode: boolean, nosave?: boolean) {
...
export function previewFontFamily(font: FontFamily) {
  if (font === undefined) {
    font = "roboto_mono";
  }
...
//font family
export function setFontFamily(font: FontFamily | "", nosave?: boolean) {
...
//freedom
export function setFreedomMode(freedom: boolean, nosave?: boolean) {
  if (freedom === null) {
    freedom = false;
  }
...
export function setConfidenceMode(cm: ConfidenceMode, nosave?: boolean) {
...
export function setIndicateTypos(it: boolean, nosave?: boolean) {
  if (it === undefined) {
    it = false;
  }
  config.indicateTypos = it;
...
export function setCustomTheme(boolean: boolean, nosave?: boolean) {
...
export function setTheme(name: Theme, nosave?: boolean) {
  config.theme = name;
...
function setThemes(theme: Theme, customState: boolean, nosave?: boolean) {
  config.theme = theme;
...
export function setRandomTheme(val: RandomTheme | boolean, nosave?: boolean) {
  if (val === undefined || val === true || val === false) {
    val = "off";
  }
  if (val === "off") {
...
export function setBritishEnglish(val: boolean, nosave?: boolean) {
  if (!val) {
    val = false;
  }
...
export function setLazyMode(val: boolean, nosave?: boolean) {
  if (!val) {
    val = false;
  }
  config.lazyMode = val;
...
export function toggleCustomTheme(nosave?: boolean) {
...
export function setCustomThemeColors(colors: string[], nosave?: boolean) {
  if (colors !== undefined) {
...
export function setLanguage(language: Language, nosave?: boolean) {
...
export function toggleMonkey(nosave?: boolean) {
...
export function setMonkey(monkey: boolean, nosave?: boolean) {
...
export function setKeymapMode(mode: KeymapMode, nosave?: boolean) {
  if (mode === null || mode === undefined) {
    mode = "off";
  }
...
export function setKeymapStyle(style: KeymapStyle, nosave?: boolean) {
...
export function setKeymapLayout(layout: KeymapLayout, nosave?: boolean) {
...
export function setLayout(layout: Layout, nosave?: boolean) {
  if (layout === null || layout === undefined) {
    layout = "qwerty";
  }
...
// export function setSavedLayout(layout, nosave?: boolean) {
//   if (layout === null || layout === undefined) {
//     layout = "qwerty";
//   }
...
export function setFontSize(fontSize: FontSize, nosave?: boolean) {
...
export function setCustomBackground(value: string, nosave?: boolean) {
  ...
  if (
    ...
    // TODO delete Command when CommandlineLists is done
    CommandlineLists.defaultCommands.list.filter(
      (command: Command) => command.id === "changeCustomBackground"
...
export function setCustomLayoutfluid(
  value: CustomLayoutFluid,
  nosave?: boolean
) {
  if (value === null || value === undefined) {
    value = "qwerty#dvorak#colemak";
  }
  value = value.replace(/ /g, "#") as CustomLayoutFluid;
  ...
  // TODO delete Command when CommandlineLists is done
  CommandlineLists.defaultCommands.list.filter(
    (command: Command) => command.id === "changeCustomLayoutfluid"
...
export function setMonkeyPowerLevel(level: MonkeyPowerLevel, nosave?: boolean) {
  if (!["off", "1", "2", "3", "4"].includes(level)) level = "off";
  config.monkeyPowerLevel = level;
  if (!nosave) saveToLocalStorage();
}

export function setBurstHeatmap(value: boolean, nosave?: boolean) {
  if (!value) {
    value = false;
  }
...
export function apply(configObj: Config | "null") {
  ...
  (Object.keys(defaultConfig) as (keyof Config)[]).forEach((configKey) => {
    if (configObj[configKey] === undefined) {
      configObj[configKey] = defaultConfig[configKey] as never;
    }
  });
  if (configObj) {
...
export function loadFromLocalStorage() {
  ...
  const localStorageConfigString = window.localStorage.getItem("config");
  let newConfig: Config;
  if (
    localStorageConfigString !== undefined &&
    localStorageConfigString !== null &&
    localStorageConfigString !== ""
  ) {
    try {
      newConfig = JSON.parse(localStorageConfigString);
    } catch (e) {
      newConfig = {} as Config;
    }
    apply(newConfig);
...
export function getConfigChanges() {
  const configChanges = {} as Config;
  (Object.keys(config) as (keyof Config)[])
    .filter((key) => {
      return config[key] !== defaultConfig[key];
    })
    .forEach((key) => {
      configChanges[key] = config[key] as never;
    });
...
export let loadPromise = new Promise((resolve) => {
  loadDone = resolve;
});
