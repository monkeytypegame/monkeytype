...
export const Fonts: Record<KnownFontName, FontConfig> = {
  Roboto_Mono: { fileName: "Roboto-Regular.woff2" },
  ...
  Roboto: { fileName: "RobotoMono-Regular.woff2" },
  ...
  Boon: { display: "Boon (ไทย)", fileName: "Boon-Regular.woff2" },
  ...
  "0xProto": { fileName: "0xProto-Regular.woff2" },
};
