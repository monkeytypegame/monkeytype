...
export function init(
  ...
  if (
    ...
    addNotification("You haven't missed any words", 0);
    return false;
  }
  ...
  if (slow) {
    ...
    if (sortableSlowWords.length === 0) {
      addNotification("Test too short to classify slow words.", 0);
    }
  }
  ...
  if (
    ...
    addNotification("Could not start a new custom test", 0);
    return false;
  }
