...
interface RetryOptions<ResponseDataType> {
...
const DEFAULT_RETRY_OPTIONS: Required<RetryOptions<any>> = {
...
export async function withRetry<ResponseDataType = any>(
  fn: () => Ape.EndpointData<ResponseDataType>,
