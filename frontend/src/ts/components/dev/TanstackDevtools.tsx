...
import { nonReactiveQueryClient, queryClient } from "../../queries";
  ...
  return (
    <TsDevTools
      plugins={[
        ...
        {
          id: "tanstack-query-nonreactive",
          name: "TanStack Query NonReactive",
          render: () => (
            <SolidQueryDevtoolsPanel client={nonReactiveQueryClient} />
          ),
        },
