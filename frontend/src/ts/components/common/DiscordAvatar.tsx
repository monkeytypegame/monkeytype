...
export function DiscordAvatar(props: {
  ...
  return (
    <div class="grid grid-cols-[1.25em_max-content_auto] items-center justify-items-start gap-2">
      <div class="col-start-1 col-end-2 row-start-1 row-end-2 grid h-[var(--size)] w-[var(--size)] place-content-center leading-[var(--size)] text-[var(--size)] transition-[opacity,filter] duration-[125ms] [--size:1em]">
        <Conditional
          if={
