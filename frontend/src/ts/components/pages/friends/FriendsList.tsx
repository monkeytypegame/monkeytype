...
import { DataTableColumnDef, DataTable } from "../../ui/table/DataTable";
...
export function FriendsList(props: {
  ...
  const removeFriendModal = new SimpleModal({
    ...
    execFn: async (thisPopup) => {
      ...
      void props.onDelete(connectionId);
  ...
  const columns = createMemo(() =>
    getColumnDefinitions({
      removeFriend: (id: string, name: string) =>
        removeFriendModal.show([id, name], {}),
    }),
  );
...
function getColumnDefinitions({
  ...
  removeFriend: (id: string, name: string) => void;
