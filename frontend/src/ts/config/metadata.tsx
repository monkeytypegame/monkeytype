...
export const configMetadata = {
  ...
  tribeDelta: {
    ...
    changeRequiresRestart: false,
    group: "tribe",
    description: `Display the speed difference to the leader / person in second place (depending on your position in the race).`,
    isBlocked: () => {
  ...
  tribeCarets: {
    ...
    changeRequiresRestart: false,
    group: "tribe",
    description: "Display carets for other players during the race.",
    isBlocked: () => {
      return getTribeMode() === "disabled";
    },
  },
