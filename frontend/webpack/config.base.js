...
const BASE_CONFIG = {
  ...
  resolve: {
    ...
    alias: {
      ...
      "@account": resolve(__dirname, "../src/scripts/account"),
      "@ape": resolve(__dirname, "../src/scripts/ape"),
      "@constants": resolve(__dirname, "../src/scripts/constants"),
      "@controllers": resolve(__dirname, "../src/scripts/controllers"),
      "@elements": resolve(__dirname, "../src/scripts/elements"),
      "@observables": resolve(__dirname, "../src/scripts/observables"),
      "@pages": resolve(__dirname, "../src/scripts/pages"),
      "@popups": resolve(__dirname, "../src/scripts/popups"),
      "@settings": resolve(__dirname, "../src/scripts/settings"),
      "@states": resolve(__dirname, "../src/scripts/states"),
      "@test": resolve(__dirname, "../src/scripts/test"),
      "@utils": resolve(__dirname, "../src/scripts/utils"),
      "@root": resolve(__dirname, "../src/scripts"),
