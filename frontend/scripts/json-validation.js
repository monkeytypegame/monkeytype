    ...
    const funboxSchema = {
      ...
      items: {
        ...
        properties: {
          ...
          changesCapitalisation: { type: "boolean" },
          mode: { type: "MonkeyTypes.Mode" },
          blockWordHighlight: { type: "boolean" },
          nospace: { type: "boolean" },
          noPunctuation: { type: "boolean" },
          noNumbers: { type: "boolean" },
          symmetricChars: { type: "boolean" },
          conflictsWithSymmetricChars: { type: "boolean" },
          toPushCount: { type: "number" },
          changesWordsVisibility: { type: "boolean" },
          speaks: { type: "boolean" },
          unspeakable: { type: "boolean" },
          changesLayout: { type: "boolean" },
          ignoresLayout: { type: "boolean" },
          usesLayout: { type: "boolean" },
          getWord: { type: "boolean" },
          punctuateWord: { type: "boolean" },
          withWords: { type: "boolean" },
          alterText: { type: "boolean" },
          applyCSS: { type: "boolean" },
          applyConfig: { type: "boolean" },
          rememberSettings: { type: "boolean" },
          toggleScript: { type: "boolean" },
          pullSection: { type: "boolean" },
          handleSpace: { type: "boolean" },
          handleChar: { type: "boolean" },
          isCharCorrect: { type: "boolean" },
          preventDefaultEvent: { type: "boolean" },
          handleKeydown: { type: "boolean" },
          getResultContent: { type: "boolean" },
          start: { type: "boolean" },
