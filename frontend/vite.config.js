...
//import { getFontawesomeClasses } from "./scripts/fontawesome.mjs";
//const fontawesomeClasses = getFontawesomeClasses();

//OR use manual config (generated from the scripts/fontawesome on demand)
const fontawesomeClasses = {
  ...
  brands: ["discord", "twitter", "patreon", "github", "google"],
};
