...
interface DebugStats {
  lastResult?: MonkeyTypes.GenericResult;
  start: number;
  end: number;
  wpmHistory: number[];
  rawHistory: number[];
...
export let lastResult: MonkeyTypes.GenericResult;

export function setLastResult(result: MonkeyTypes.GenericResult): void {
  lastResult = result;
}
