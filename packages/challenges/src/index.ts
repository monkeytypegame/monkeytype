...
export const Challenges: Record<ChallengeName, Omit<Challenge, "name">> = {
  ...
  alpha: {
    ...
    category: "speed",
    description:
      "Type the alphabet, with each letter separated by a space and in alphabetical order a b c d e f g h i j k l m n o p q r s t u v w x y z in LESS than 3.37 seconds.",
  },
  blazeIt: {
    display: "Blaze It",
    type: "hidden",
