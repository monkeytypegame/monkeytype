...
Then, go to `./packages/contracts/src/schemas/config.ts` and add your new theme name at the _end_ of the `ThemeNameSchema` enum. Make sure to end the line with a comma. 
